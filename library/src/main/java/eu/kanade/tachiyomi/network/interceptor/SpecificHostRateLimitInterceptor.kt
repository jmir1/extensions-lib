 ...
 * Examples:
 *
 * httpUrl = "https://api.anime.example".toHttpUrl(), permits = 5, period = 1, unit = seconds  =>  5 requests per second to api.anime.example
 * httpUrl = "https://cdn.anime.example/images".toHttpUrl(), permits = 10, period = 2, unit = minutes  =>  10 requests per 2 minutes to cdn.anime.examples
 *
